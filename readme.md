...
* **Reporting:** Click "Report to _____" to generate a pre-formatted Outlook email draft for failed machines, including their log details and duration.

**How to use:**
1. Ensure you have Python installed and are connected to the network (access to `\\sccm.fqdn...` is required).
2. Run the script.
